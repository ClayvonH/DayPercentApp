...
//    }
//    
//    private func fetchTasksAndGoalsForToday() {
//        taskVM.fetchTasksForDate(for: today)
//        goalVM.fetchGoalsForDate(for: today)
//        timerVM.updateAllRunningTaskTimers(date: today, tasks: displayedTasks)
//        timerVM.setAllTimerVals(date: today, tasks: displayedTasks)
//        timerVM.beginProgressUpdates(for: today, tasks: displayedTasks)
//    }
//
//    
//    var body: some View {
